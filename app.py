...
CORS(app)  # Allow the HTML frontend to call our API

# --- Serve the HTML frontend ---
@app.route("/")
def index():
    """Serve bookings.html as the main page"""
...
def rooms(): return get_all_rooms()

@app.route("/rooms/available", methods=["GET"])
@app.route("/api/rooms/available", methods=["GET"])
def rooms_available(): return get_available_rooms()

# --- Booking Routes ---
@app.route("/bookings", methods=["GET"])
@app.route("/api/bookings", methods=["GET"])
def bookings_get(): return get_bookings()

@app.route("/bookings", methods=["POST"])
@app.route("/api/bookings", methods=["POST"])
def bookings_create(): return create_booking()

@app.route("/bookings/<int:booking_id>", methods=["DELETE"])
@app.route("/api/bookings/<int:booking_id>", methods=["DELETE"])
def bookings_delete(booking_id): return delete_booking(booking_id)
